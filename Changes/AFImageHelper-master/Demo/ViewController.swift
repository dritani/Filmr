...
class ViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        if let image = UIImage(text: "Ma", font: UIFont.systemFontOfSize(textSize), color: UIColor.whiteColor(), backgroundColor: UIColor.blueColor(), size: CGSize(width: imageWidth, height: imageHeight))
